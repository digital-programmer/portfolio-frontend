    ...
    <div className="flex flex-col gap-[32px] justify-center">
      ...
      <div className="flex items-center gap-4 flex-wrap">
        <Link href={"/contact"} className="w-max inline-block">
          <button
            type="button"
            className="text-text-50 dark:text-text-950 bg-gradient-to-br from-accent-400 to-accent-500 hover:bg-gradient-to-bl focus:outline-none font-medium rounded-lg text-xs md:text-sm px-4 py-2 md:px-6 md:py-2.5 text-center dark:from-accent-500 dark:to-accent-600 flex items-center"
          >
            Get In Touch
          </button>
        </Link>
