    ...
    <Suspense fallback={''}>
      <Link href={resumeLink as string} target="_blank" className="w-max inline-block">
        <button className="relative inline-flex overflow-hidden rounded-lg p-[2px] focus:outline-none outline-none">
          ...
          <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-white dark:bg-background-100 px-4 py-2 md:px-6 md:py-2.5 font-medium backdrop-blur-3xl text-text-950 dark:text-text-950 text-xs md:text-sm">
            Download Resume
          </span>
        </button>
      </Link>
