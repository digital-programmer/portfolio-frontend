    ...
    >
      <div className="bg-white dark:bg-background-100 rounded-lg flex flex-col gap-6 px-4 py-6 md:py-8 text-center">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="font-light text-sm leading-5 text-text-950 dark:text-text-950">
            ...
            deployment, ensuring alignment with business goals and delivering
      ...
      <div className="bg-white dark:bg-background-100 rounded-lg flex flex-col gap-6 px-4 py-6 md:py-8 text-center">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="font-light text-sm leading-5 text-text-950 dark:text-text-950">
            Create responsive and visually appealing web designs that look great
            on any device, from mobile phones to desktop computers. Your site
            will be optimized for all screen sizes
          </div>
        </div>
      </div>
      <div className="bg-white dark:bg-background-100 rounded-lg flex flex-col gap-6 px-4 py-6 md:py-8 text-center">
      ...
      <div className="bg-white dark:bg-background-100 rounded-lg flex flex-col gap-6 px-4 py-6 md:py-8 text-center">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="font-light text-sm leading-5 text-text-950 dark:text-text-950">
            I rapidly adapt to new technologies and environments, continuously
            enhancing my skills to stay at the forefront of industry
            advancements.
          </div>
        </div>
      </div>
